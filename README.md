...
NOVA is a cluster of neural networks designed to make predictions based of the dataset given.
In this example we use the california housing dataset.
It works by setting up the data correctly and feeding it inside the neural network made with pytorch.
There are options for number of networks in a cluster or use the single network mode.
